var ScrapeData = {};
  ...
  function Scraping(){
    ...
    ScrapeData = {
        ...
        'reviews' :  (document.querySelectorAll('[data-testid=featuredreview-text]')[0]) ? document.querySelectorAll('[data-testid=featuredreview-text]')[0].innerText.trim() : result.hotel_detail.reviews,
        // All Reviews
